...
def main(args=None):
    ...
    if args.use_gpu and args.use_multi_gpu:
        ...
        args.gpu = args.device_ids[1]  # Make sure you have at least two GPUs if you set this to 1.
...
for store in ['2', '3', '4']:
    root_path_name = "C:/Users/pinyo/OneDrive/Data/Gosoft/demand-forecasting/StoreFocus/"
    data_path_name = f"multivar_train_50items_store{store}.csv"
    model_id_name = f"SalesMultivarStore{store}"
    data_name = "Sales"
    ...
    a = sys.argv.extend(['--is_training', '1',
                        ...
                        '--enc_in', num_vars,  # The number of input columns for encoder.
                        '--cycle', cycle_period,
                        '--train_epochs', '30',
                        '--patience', '5',
                        '--itr', '1',
